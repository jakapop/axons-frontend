...
onMounted(() => {
  ...
  Promise.all(requests).then((responses) => {
    console.log('prommise == ',responses);
...
<template>
  <NavbarMain>
    <div>
    <div
      class="bg-white rounded-2xl p-2 m-4 mt-16 md:mt-8">
      ...
      <div class="flex justify-center items-center">
        <div class="h-auto w-full bg-white rounded-lg p-3.5 md:p-0 lg:p-0 ">
          ...
          <div  class="text-center mt-2 mb-[16px]">
      ...
      <div>
        <div v-if="states.activities_today != ''" class=" w-full h-auto md:h-[550px] overflow-y-auto ">
          ...
          <div v-for="(activity, index) in states.activities_today" :key="index"
            ...
            <div class="flex flex-row w-full">
              ...
              <div
                class="flex flex-col justify-between w-3/5 sm:w-9/12">
        ...
        <div v-else class="w-full">
          <div
            class="bg-white rounded-[16px] py-1.5 px-2 flex flex-col justify-between leading-normal h-[230px] md:h-[500px] ">
            <div class="text-center">
